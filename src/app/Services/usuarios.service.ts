...
export class UsuariosService {
  ...
  obtenerUsuarioPorCedula(cedula: any): Observable<ReponseApi> {

    return this.http.get<any>(`${this.urlApi}ObtenerUsuarioPoCedula/${cedula}`,{}).pipe(
      catchError(this.handleError)
    );
  }
  ...
  listaClientes(): Observable<ReponseApi> {
    const headers = this.getHeaders();
    return this.http.get<any>(`${this.urlApi}ListaClientes`, { headers: headers }).pipe(
      catchError(this.handleError)
    );
  }
